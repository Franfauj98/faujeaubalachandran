...
namespace render {
  ...
  public:
    ...
    void handleServer (sf::RenderWindow& window, state::Observable& principalMap, sf::Event& event, bool& firstC, bool& secondC, bool& thirdC, std::deque<std::string>& command, int& idPalace, int& idPlayer);
    // Setters and Getters
  };
