...
/*
améliorer batiments dès qu'il peut s'il a ressources : hdv caserne ressource
créer unités dès qu'il peut
avancer vers un empire choisi aléatoirement
avancer toutes les unités ensemble : prendre l'unité le plus loin à chaque fois puis faire la distance A* pour trouver plus court chemiun
si sur chemiun unités se battent
attaquer hdv
rechoississent un empire
 */
